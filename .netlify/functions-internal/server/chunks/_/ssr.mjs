import { createRootRoute, Outlet, HeadContent, Link, Scripts, createFileRoute, lazyRouteComponent, RouterProvider, createRouter as createRouter$1 } from '@tanstack/react-router';
...
async function loadVirtualModule(id) {
  switch (id) {
    ...
    case VIRTUAL_MODULES.startManifest:
      return await import('./_tanstack-start-manifest_v-BEKVUsto.mjs');
...
const appCss = "/assets/app-CA--dYc2.css";
...
function RootDocument({
  ...
  return /* @__PURE__ */ jsxs("html", { children: [
    ...
    /* @__PURE__ */ jsxs("body", { className: "h-screen", children: [
      /* @__PURE__ */ jsxs("div", { className: "p-2 flex gap-2 text-lg", children: [
        ...
        /* @__PURE__ */ jsx(Link, { to: "/test", activeProps: {
          className: "font-bold"
        }, activeOptions: {
          exact: true
        }, children: "Test" })
...
const $$splitComponentImporter$1 = () => import('./test-BXS1D_uO.mjs');
const Route$1 = createFileRoute("/test")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import('./index-D-JBpvYs.mjs');
